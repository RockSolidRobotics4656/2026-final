...
public class Robot extends TimedRobot {
  ...
  public void autonomousPeriodic() {
   ...
   /* ------------------------------------------------------------------------------------ */
      ...
      if (Auto.kautoVariable == 6 & Timer.getMatchTime() < 20 & Timer.getMatchTime() > Shoot.kAutoShootStop) {
        System.out.println("Shoot init");
        shootIsMoving = true;
        // shootStartTime = Timer.getTimestamp();
        // System.out.println(shootStartTime);
      ...
      if (Auto.kautoVariable == 6 & Shoot.kAutoShootInit < Timer.getMatchTime()  /*Timer.getMatchTime() > 10*/) {
          m_backKickMotor.set(0);
          m_frontKickMotor.set(0);
      }

      if (Auto.kautoVariable == 6 & 
        Timer.getMatchTime() < Shoot.kAutoShootInit & Timer.getMatchTime() > Shoot.kAutoShootStop) {
        System.out.println("start kick");
        // m_shootMotor.set(Shoot.kRunMotorSpeed);
        m_backKickMotor.set(Shoot.kKickMotorSpeed);
        m_frontKickMotor.set(Shoot.kFrontKickMotorSpeed);
      ...
      if (Auto.kautoVariable == 6 & Timer.getMatchTime() < Shoot.kAutoShootStop) {
          System.out.println("Shoot Stopper");
          m_shootMotor.set(Shoot.kStoppedMotor);
          m_backKickMotor.set(Shoot.kStoppedMotor);
          m_frontKickMotor.set(Shoot.kStoppedMotor);
